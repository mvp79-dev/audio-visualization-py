...
class AnimatedAudioVisualizer:
    ...
    def make_frame(self, t, y, sr, total_duration):
        ...
        fig.patch.set_facecolor('purple')  # Black background for the figure
        ax_waveform.set_facecolor('purple')  # Black background for the waveform axis
        ax_spectrogram.set_facecolor('purple')  # Black background for the spectrogram axis
